      ...
      <section className='mb-16 flex w-full max-w-3xl flex-col items-center text-center'>
        ...
        <div className='flex flex-col items-center justify-center gap-4 sm:flex-row'>
          ...
          <a
            ...
            className='flex items-center gap-2 rounded-xl border border-slate-800/30 bg-slate-900/80 px-4 py-2 font-semibold text-white shadow backdrop-blur transition-colors hover:bg-slate-900/90'
          >
